  ...
  return (
    <main className="min-h-screen pt-32 pb-20 relative bg-[#060a14]">
      <article className="container mx-auto px-4 max-w-3xl">
        ...
        {/* Header / Title */}
        <h1 className="text-4xl md:text-[2.75rem] font-bold text-white mb-4 leading-tight tracking-tight break-words">
          {blog.title}
        </h1>
        
        {/* Excerpt / Subtitle */}
        <p className="text-xl text-slate-300 mb-8 leading-relaxed font-serif break-words">
          {blog.excerpt}
        </p>
